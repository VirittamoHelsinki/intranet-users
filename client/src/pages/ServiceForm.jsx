        ...
        <main className='flex flex-col items-center'>
            <div className={clsx('flex flex-col', id !== 'new' ? 'gap-4' : 'gap-2')}>
                <h2 className='text-xl font-bold'>
                    {id !== 'new' ? 'Muokkaa sovelluksen tietoja' : 'Lisää uusi sovellus Virittämö portaaliin'}
                </h2>
        {id === 'new' && <p className='text-sm opacity-70 pb-3'>Sovellukset ovat portaaliin lisättäviä lisäominaisuuksia.</p>}
                <form onSubmit={onSubmit} className='flex flex-col gap-3 max-w-md'>
                    <div className='flex flex-col gap-2'>
                        <div className='flex items-center gap-1'>
                            <Label htmlFor="name">Palvelun nimi</Label>
                            <HelpMe>Anna lisättävälle sovellukselle nimi esim. `kauppakassi-sovellus` pienillä kirjaimilla. Sovelukset ovat portaaliin lisättäviä lisäominaisuuksia. </HelpMe>
                        </div>
                        <Input
                            type="text"
                            id="name"
                    ...
                    <div className='flex flex-col gap-2'>
                        <div className='flex items-center gap-1'>
                            ...
                            <HelpMe>Anna sovelluksen subdomain- tai domain-osoite esim. `kuutio.intranet.com`, joka viitaa sovelluksen sijaintiin palvelimella tai pilvipalvelussa.</HelpMe>
                        </div>
                        <Input
                            type="text"
                            id="domain"
                    ...
                    {/* <div className='flex flex-col gap-2'>
                        <div className='flex items-center gap-1'>
                            ...
                            <HelpMe>Luo uniikki sovelusavain käyttäen auto generate-toimintoa tai käsin syöttämällä. Avainta voi muokata myöhemmin. Avain syötetään sovelluksen ympäristömuuttujiin .env-tiedostoon.</HelpMe>
                        </div>
                        <Textarea
                            id="serviceKey"
                            rows="4"
                            cols="50"
                            placeholder="e4uy535bnd8d9vd98f"
                            value={serviceKey}
                    ...
                    <div className='flex flex-col gap-2 w-96 max-w-sm'>
                        ...
                        <div className='flex w-full max-w-sm items-center gap-x-2'>
                            <Input
                                ...
                                className="w-full"
                            />
                            <Button variant='ghost' type='button' onClick={() => setServiceKey(uuidv4())}>
